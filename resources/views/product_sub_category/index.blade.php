        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('category_list') }}">Sub Categories</a>
                    </li>
        ...
        <div class="card mx-4">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between my-4">
                    ...
                    <a href="{{route('subcategory_add')}}" class="btn btn-primary btn-sm rounded"><i class="fa fa-plus"></i> Add New Sub Category</a>
                </div>
